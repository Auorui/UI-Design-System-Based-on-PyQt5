...
class CamShow(QMainWindow,Ui_MainWindow):
    ...
    def PrepParameters(self):
        ...
        self.ExpTimeSld.setValue(int(self.camera.get(15)))
        self.SetExposure()
        self.GainSld.setValue(int(self.camera.get(14)))
        self.SetGain()
        self.BrightSld.setValue(int(self.camera.get(10)))
        self.SetBrightness()
        self.ContrastSld.setValue(int(self.camera.get(11)))
        self.SetContrast()
        self.MsgTE.clear()
